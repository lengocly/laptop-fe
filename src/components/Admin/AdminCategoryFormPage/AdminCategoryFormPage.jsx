/**
 * AdminCategoryFormPage — Thêm / Sửa danh mục
 * parent_id = null → nhóm cha (Laptop, Phụ kiện)
 * parent_id = id nhóm → danh mục con (ASUS, Chuột...)
 * is_featured = hiện khối "Danh mục nổi bật" trang chủ
 * sort_order = thứ tự trong menu/danh sách (1 lên trước 2), KHÔNG phải bật nổi bật
 */
